class BalanceTree{
	...
	boolean isBalance(Node root){
		...
		int leftBa = heightTree(root.left);
		int rightBa = heightTree(root.right);
		int Balance = leftBa - rightBa;
	...
	public static void main(String args[]){
		BalanceTree ht = new BalanceTree();
		ht.insert(10);
		ht.insert(3);
		ht.insert(2);
		ht.insert(14);
		...
		System.out.println("\n Is Balance : "+ht.isBalance(ht.root));
	}
}
